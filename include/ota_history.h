...
// Persisted record of the most recent OTA update's outcome (main.cpp's
...
// "otastate" NVS namespace, kept together here instead of main.cpp poking
...
// Called once, right when main.cpp's boot-time checks confirm a real
...
// The dedup marker checkOtaRollback (main.cpp) uses to avoid re-alerting
